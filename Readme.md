# Android Remote Access Research Lab
...
1. Configure dynamic DNS for your lab network
2. Open required ports (research environment only)
3. Generate APK with your lab configuration
4. Install on **your own test device**
5. Analyze behavior using security tools
